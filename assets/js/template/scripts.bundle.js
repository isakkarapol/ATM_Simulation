            ...
            afterRender: function (e, args) {
                if (args.table === $(datatable.table).attr('id')) {
                    ...
                    $(datatable).ready(function () {
                        ...
                        if (localStorage.getItem("Document_CE") != null) {
                            if (typeof copy_doc_ce !== 'undefined' && $.isFunction(copy_doc_ce)) {
                                if (localStorage.getItem("Document_CE") != "") {
                                    copy_doc_ce();
                                }
                            }
                        }
...
//                        }
//                        if (array_customs.length > 0) {// Modify By Joke : Check have ERROR after response API and after load data in Datatable  // 16/2/2018
//                            show_customs(array_customs); // This variable is in  views->joblist.php  
//                        }
                    });
                }
            },
