...
abstract class REST_Controller extends CI_Controller {
    ...
    public function __construct($config = 'rest') {
        ...
        // Save Request ID to $_request_id
        $headers = $this->getAllHeader();
        $this->_request_id = ( isset($headers['TMS-REQUEST-ID']) ? $headers['TMS-REQUEST-ID'] : '' );
...
//            echo json_encode($data);
    ...
    public function response_header() {
        $object = new stdClass();
        $object->response_date = date('Y-m-d H:i:s');
        $object->response_timestamp = time();
        $object->response_id = $this->_request_id;
        $object->service_id = 1;
        $object->service_name = "ebXML";
